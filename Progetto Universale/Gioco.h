...
#include "Capacita.h"  //Modifica Gravina Antonio
#include "Capacitasingola.h"  //Modifica Gravina Antonio
...
protected:
    ...
    Pila <string> percorso;//MODIFICA SPECCHIA ROBERTO
...
//FINE MODIFICA VACCA
    ...
    //void stampaluoghi(Pila<int> &c, Pila<string> &l);
...
//INIZIO MODIFICHE SPECCHIA ROBERTO
    void ritorna(Pila <stato_comando>* sc, Mappa &M);
...
//FINE MODIFICHE LEANDRA PALEMBURGI
    ...
    void scendi_motorino(); //Modifica Gravina Antonio
};
