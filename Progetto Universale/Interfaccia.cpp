...
void Interfaccia::disegna_scena(Luogo luogo)
{
     ...
     * visitato � uguale a quello attuale (passato come parametro)
    ...
    if (luogo == ultimoLuogo)
        ...
        ultimoLuogo = luogo;
    // modifiche Bottiglione Margareth
    string desco="\000";
    desco =luogo.getDescrizione();
    //desco=desco.substr(0,desco.size()-1);//modifiche Matteo Baso
    cout << "\nSei " << desco << "." << endl;
