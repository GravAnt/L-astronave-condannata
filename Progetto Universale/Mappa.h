...
public:
    ...
    float get_lunghezza(int, int);//dato il nodo precedente e successivo restituisce il peso dell'arco
    ...
    // inizio modifica Davide Rano
    typename Grafo<etichetta,peso>::nodo nodo_da_nome_etichetta(string);
    // fine modifica Davide Rano

    //INIZIO modifiche - De Florio Cristina
    int get_numnodi ();  //restituisce il numero dei nodi presenti nella mappa
